...
val releaseVersion = rootProject.extra["fluxyReleaseVersion"] as String
...
dependencies {
    compileOnly("com.inductiveautomation.ignitionsdk:ignition-common:8.3.4")
    compileOnly("com.inductiveautomation.ignitionsdk:gateway-api:8.3.4")
    compileOnly("com.inductiveautomation.ignition:ia-gson:2.10.1")
    testImplementation("com.inductiveautomation.ignitionsdk:ignition-common:8.3.4")
