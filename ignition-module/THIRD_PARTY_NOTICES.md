...
The source tree includes the official Gradle 8.2.1 wrapper. Gradle is licensed under Apache License 2.0. The wrapper scripts retain their upstream copyright and license headers; the wrapper JAR is not part of the Fluxy `.modl`.
...
| --- | --- | --- |
| Inductive Automation Ignition SDK 8.3.4 | Compile-only host API | Inductive Automation Software License |
